<?php
	...
	class Payment_module extends CI_Model {
		...
		public function get_cart_data($user_id) {
			...
			// SELECT cart_name, user_cart.user_id,cart_number, cart_money,valyuta.valyuta_name FROM user_cart INNER JOIN valyuta ON user_cart.user_id=valyuta.cart_id WHERE user_cart.cart_display=1 AND user_cart.user_id=?
